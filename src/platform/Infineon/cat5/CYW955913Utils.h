...
#define CYW955913_ALIGN_SIZE(value, align_to) (((value) + (align_to) -1) & ~((align_to) -1))
...
public:
    ...
    static CHIP_ERROR cyw955913_wifi_get_config(wifi_interface_t interface, wifi_config_t * conf);
    static CHIP_ERROR cyw955913_wifi_set_config(wifi_interface_t interface, wifi_config_t * conf);
    static CHIP_ERROR cyw955913_wifi_disconnect(void);
    static CHIP_ERROR cyw955913_wifi_connect(void);
    static CHIP_ERROR cyw955913_start_ap(void);
    static CHIP_ERROR cyw955913_stop_ap(void);
