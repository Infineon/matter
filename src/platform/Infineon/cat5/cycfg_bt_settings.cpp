 ...
 ****************************************************************************/
    ...
    const wiced_bt_cfg_ble_scan_settings_t cy_bt_cfg_scan_settings =
    {
        ...
        .conn_min_interval               = BLE_CONNECTION_INTERVAL,                                       /* Minimum connection interval (in slots (1 slot = 1.25 ms)) */
        .conn_max_interval               = BLE_CONNECTION_INTERVAL,                                       /* Maximum connection interval (in slots (1 slot = 1.25 ms)) */
