...
//        bdadr = &p_event_data->ble_connection_param_update.bd_addr;
//        printf("%02X:%02X:%02X:%02X:%02X:%02X\n",bdadr[0],bdadr[1],bdadr[2],bdadr[3],bdadr[4],bdadr[5]);
        printf("ble_connection_param_update.conn_interval       : %f ms\r\n",
               (double)(p_event_data->ble_connection_param_update.conn_interval * 1.25f));
    ...
    case BTM_ENABLED_EVT:
        // Post a event to _OnPlatformEvent.
        {
            ...
            bleEvent.Type = DeviceEventType::kCYW955913BLEEnabledEvt;
    ...
    case BTM_ENCRYPTION_STATUS_EVT:
        ...
        {
            ChipLogProgress(DeviceLayer, "Encryption Status Event: SUCCESS");
        }
        else /* Encryption Failed */
        {
            ChipLogProgress(DeviceLayer, "Encryption Status Event: FAILED");
        }
        break;

    case BTM_BLE_ADVERT_STATE_CHANGED_EVT:
        ChipLogProgress(DeviceLayer, "Advertisement state changed to %d", p_event_data->ble_advert_state_changed);
        break;
...
void BLEManagerImpl::_OnPlatformEvent(const ChipDeviceEvent * event)
{
    ...
    case DeviceEventType::kCYW955913BLEEnabledEvt:
...
// TODO use CY_BT_CONN_MAX_INTERVAL?
#define CONNECTION_INTERVAL (80)
...
// TODO
        ...
        p_conn_params.conn_interval_min = CONNECTION_INTERVAL;
        p_conn_params.conn_interval_max = CONNECTION_INTERVAL + 1;
        p_conn_params.conn_latency = CY_BT_CONN_LATENCY;
        p_conn_params.conn_supervision_timeout = SUPERVISION_TIMEOUT;
        p_conn_params.min_ce_length = 0;
        p_conn_params.max_ce_length = 0;

        wiced_bool_t conn_param_status = wiced_bt_l2cap_update_ble_conn_params(p_conn_status->bd_addr, &p_conn_params);
