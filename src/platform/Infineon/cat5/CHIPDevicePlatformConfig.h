...
#define CHIP_DEVICE_CONFIG_NETXDUO_WIFI_STATION_IF_NAME "infineon"
...
#define CHIP_DEVICE_CONFIG_DEVICE_VENDOR_ID 0x1388

#define CHIP_DEVICE_CONFIG_THREAD_TASK_PRIORITY (CY_RTOS_PRIORITY_NORMAL)
