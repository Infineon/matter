...
class CYW955913ScanResponseIterator : public Iterator<WiFiScanResponse>
{
public:
    CYW955913ScanResponseIterator(const size_t size, const cy_wcm_scan_result_t * scanResults) : mSize(size), mpScanResults(scanResults) {}
...
class CYW955913WiFiDriver final : public WiFiDriver
{
public:
    class WiFiNetworkIterator final : public NetworkIterator
    {
    public:
        WiFiNetworkIterator(CYW955913WiFiDriver * aDriver) : mDriver(aDriver) {}
    ...
    static CYW955913WiFiDriver & GetInstance()
    {
        static CYW955913WiFiDriver instance;
        return instance;
    }
