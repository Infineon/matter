 ...
 *          Layer on the CYW955913 platform.
 *
 */
...
#define CHIP_SYSTEM_CONFIG_NETXDUO_EVENT_TYPE int
#define CHIP_SYSTEM_CONFIG_NETXDUO_EVENT_OBJECT_TYPE const struct ::chip::DeviceLayer::ChipDeviceEvent *
...
#define CHIP_SYSTEM_NETXDUO_ERROR_MIN 3000000
#define CHIP_SYSTEM_NETXDUO_ERROR_MAX 3000128
