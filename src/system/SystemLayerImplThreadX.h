...
/**
 *    @file
 *      This file declares an implementation of LayerImplThreadX using LwIP.
 */
...
class LayerImplThreadX : public LayerThreadX
{
public:
    LayerImplThreadX();
    ~LayerImplThreadX() { VerifyOrDie(mLayerState.Destroy()); }
...
using LayerImpl = LayerImplThreadX;
