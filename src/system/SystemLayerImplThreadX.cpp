...
/**
 *    @file
 *      This file implements LayerImplThreadX. Used by NetXDuo implementation.
 */
...
#include <system/SystemLayerImplThreadX.h>

namespace chip {
namespace System {

LayerImplThreadX::LayerImplThreadX() : mHandlingTimerComplete(false) {}

CHIP_ERROR LayerImplThreadX::Init()
{
    VerifyOrReturnError(mLayerState.SetInitializing(), CHIP_ERROR_INCORRECT_STATE);

#if CHIP_SYSTEM_CONFIG_USE_NETXDUO
    RegisterNetXDuoErrorFormatter();
...
void LayerImplThreadX::Shutdown()
{
    mLayerState.ResetFromInitialized();
}

CHIP_ERROR LayerImplThreadX::StartTimer(Clock::Timeout delay, TimerCompleteCallback onComplete, void * appState)
{
...
CHIP_ERROR LayerImplThreadX::ExtendTimerTo(Clock::Timeout delay, TimerCompleteCallback onComplete, void * appState)
{
...
bool LayerImplThreadX::IsTimerActive(TimerCompleteCallback onComplete, void * appState)
{
    return (mTimerList.GetRemainingTime(onComplete, appState) > Clock::kZero);
}

Clock::Timeout LayerImplThreadX::GetRemainingTime(TimerCompleteCallback onComplete, void * appState)
{
    return mTimerList.GetRemainingTime(onComplete, appState);
}

void LayerImplThreadX::CancelTimer(TimerCompleteCallback onComplete, void * appState)
{
    assertChipStackLockedByCurrentThread();
...
CHIP_ERROR LayerImplThreadX::ScheduleWork(TimerCompleteCallback onComplete, void * appState)
{
    assertChipStackLockedByCurrentThread();
 ...
 */
CHIP_ERROR LayerImplThreadX::StartPlatformTimer(System::Clock::Timeout aDelay)
{
 ...
 *
 */
CHIP_ERROR LayerImplThreadX::HandlePlatformTimer()
{
    VerifyOrReturnError(IsInitialized(), CHIP_ERROR_INCORRECT_STATE);
