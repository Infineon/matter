 ...
 */
#if !CHIP_SYSTEM_CONFIG_USE_LWIP && !CHIP_SYSTEM_CONFIG_USE_NETXDUO && (CHIP_SYSTEM_CONFIG_PACKETBUFFER_POOL_SIZE == 0)
...
#if (CHIP_SYSTEM_CONFIG_USE_LWIP + CHIP_SYSTEM_PACKETBUFFER_FROM_CHIP_HEAP + CHIP_SYSTEM_PACKETBUFFER_FROM_CHIP_POOL + CHIP_SYSTEM_CONFIG_USE_NETXDUO) != 1
